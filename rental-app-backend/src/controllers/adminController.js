...
var getPendingProperties = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var properties, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, Property_1.Property.find({ status: 'pending' })];
            case 1:
                properties = _a.sent();
...
// Approve a property
var approveProperty = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, Property_1.Property.findByIdAndUpdate(id, { status: 'approved' }, { new: true })];
            case 2:
                property = _a.sent();
                if (!property) {
                    res.status(404).json({ message: 'Property not found' });
                    return [2 /*return*/]; // Exit the function early
                }
...
// Reject a property
var rejectProperty = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, property, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, Property_1.Property.findByIdAndUpdate(id, { status: 'rejected' }, { new: true })];
            case 2:
                property = _a.sent();
                if (!property) {
                    res.status(404).json({ message: 'Property not found' });
...
var getUserActivities = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var activities, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, UserActivity_1.UserActivity.find().populate('userId')];
            case 1:
                activities = _a.sent();
